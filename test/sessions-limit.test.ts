...
// GET /ziiagentmemory/sessions and GET /ziiagentmemory/replay/sessions
// must accept a `limit` query param so the viewer and CLI can page
// through large session tables without forcing the engine to ship
// every record on every request (#1022).
//
